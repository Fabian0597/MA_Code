...
class TimeSeriesData(Dataset):
    ...
    def __init__(self, data_path, list_of_BSD_states, window_size, overlap_size, features_of_interest):
    ...
    def concatenate_data_from_BSD_state(self, data_folders, data_path, features_of_interest, window_size, overlap_size):
        ...
        x_data_2D = self.__wavelet_transform(x_data_concatenated)
        #generate torch array
        n_samples = np.shape(x_data_2D)[0]
        x_data = torch.from_numpy(x_data_2D)
